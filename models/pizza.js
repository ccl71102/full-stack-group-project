...
const pizzaSchema = new Schema({
    ...
    sauce: {
        type: String,
        enum: ["tomato", "white", "alfredo", "pesto", "bbq"],
        default: "tomato"
    },
    price: {
        type: Number,
