A full stack single page application for a fictional pizzeria built with a combination of React, CSS, HTML for the front-end, and Node.js and MongoDB for the back-end. 
